...
/*ECATCHANGE_START(V5.12) DIAG3*/
        u8LastDiagMsgRead = 0;
/*ECATCHANGE_END(V5.12) DIAG3*/
    }
    else
    {
/*ECATCHANGE_START(V5.12) DIAG1*/
...
/*ECATCHANGE_START(V5.12) DIAG2*/
            // reset new message indication in overwrite mode
            if ((sDiagHistory.Flags & DIAG_OPERATION_MODE) == 0)
            {
                sDiagHistory.u8NewMessage = 0;
            }
/*ECATCHANGE_END(V5.12) DIAG2*/
        }
...
/*ECATCHANGE_END(V5.12) COE4*/
                ...
                {
#if MBX_16BIT_ACCESS
/*ECATCHANGE_START(V5.12) DIAG4*/
                        
                    UINT16 *pMsgParamBuffer = (UINT16 *)&pNewDiagMsg->Parameter;
/*ECATCHANGE_END(V5.12) DIAG4*/
#else
...
#if MBX_16BIT_ACCESS
/*ECATCHANGE_START(V5.12) DIAG4*/
                            pMsgParamBuffer += (LengthToCopy/2);
/*ECATCHANGE_END(V5.12) DIAG4*/
#else
