...
#if TEST_APPLICATION && EOE_SUPPORTED
/*ECATCHANGE_START(V5.12) TEST3*/
        if (index == 0x1009 && IS_TEST_ACTIVE(SendEoEOn0x1009Access))
        {
            UINT16 result = 0;
...
/*ECATCHANGE_START(V5.12) EOE4*/
            ...
            /*set source*/
            MBXMEMCMP(pSendFrame->Source.w, aMacAdd, (SIZEOF(aMacAdd)));
#else
            /*set broadcast destination*/
...
/*ECATCHANGE_END(V5.12) EOE4*/
            ...
            if (result == 0)
            {
                INC_TEST_CNT(SendEoEOn0x1009Access);
            }
...
#if TEST_APPLICATION
        if (index == 0x1009 && IS_TEST_ACTIVE(SendInvalidMbxOn0x1009Access))
        {
            UINT16 result = 0;
            ...
            if (result == 0)
            {
                INC_TEST_CNT(SendInvalidMbxOn0x1009Access);
            }
        }
/*ECATCHANGE_END(V5.12) TEST3*/
